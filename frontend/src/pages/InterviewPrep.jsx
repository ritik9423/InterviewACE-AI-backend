...
import { FiSend, FiChevronRight, FiCheckCircle, FiInfo, FiArrowLeft, FiLoader, FiCpu, FiMessageSquare, FiActivity } from 'react-icons/fi';
    ...
    if (isLoading) return (
        <div className="min-h-screen flex items-center justify-center bg-[#020617]">
            <div className="flex flex-col items-center gap-6">
                <FiCpu className="text-6xl text-indigo-500 animate-pulse" />
